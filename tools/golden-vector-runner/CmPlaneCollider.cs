...
{
    [System.Serializable]
    public class CmPlaneCollider : ICmCollider
    {
        ...
        {
            CmVector v1 = (Scale.x * Right + Scale.z * Forward) / CmMath.defoultMultiplier;
            CmVector v2 = (-Scale.x * Right + Scale.z * Forward) / CmMath.defoultMultiplier;
            CmVector v3 = (Scale.x * Right - Scale.z * Forward) / CmMath.defoultMultiplier;
            CmVector v4 = (-Scale.x * Right - Scale.z * Forward) / CmMath.defoultMultiplier;
