 ...
 * To regenerate: cd tools/golden-vector-runner && ~/.dotnet/dotnet run -c Release 2>/dev/null > ../../tests/fixtures/physics-golden-vectors.json
 * Loads from physics-golden-vectors.json (combined GV+FUZZ output), filtered to FUZZ- prefix.
 *
 * Load-bearing invariant enforced here:
 *   MAX_FORCE=13000 (premium cue); fuzz force range spans 7000..13000.
