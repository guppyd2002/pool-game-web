...
- **GLB model scale — uniform (chief architect directive 2026-07-20):** `scaleX = scaleY = scaleZ = 0.09469`. QA render confirmed: long rail +4mm (flush), pocket centred. Short rail -29mm is scale-invariant art gap. Both scene.ts and inspector.ts use this value. Do not change without explicit directive from the chief architect.
